...
BED_FILE="$(realpath "/media/linuxmac/Storage2/scripts/02_example_yeast_remodeler/add_INSPECTOR_TSS_scripts_ruven/add_INSPECTOR_TSS_scripts_ruven/TES/split_by_gene_config/tandem/TES_regSorted_tandem.bed")"
