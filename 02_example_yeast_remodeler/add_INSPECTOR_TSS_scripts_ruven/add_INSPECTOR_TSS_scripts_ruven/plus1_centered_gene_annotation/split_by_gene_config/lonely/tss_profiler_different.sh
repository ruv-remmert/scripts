...
BED_FILE="$(realpath "/media/linuxmac/Storage2/scripts/02_example_yeast_remodeler/add_INSPECTOR_TSS_scripts_ruven/add_INSPECTOR_TSS_scripts_ruven/plus1_centered_gene_annotation/split_by_gene_config/lonely/TSS_regSorted_lonely.bed
")"
