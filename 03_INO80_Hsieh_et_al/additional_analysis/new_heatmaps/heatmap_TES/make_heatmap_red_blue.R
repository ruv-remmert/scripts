...
sample_label_WT_A <- resolve_sample_label(
  "WT_A", c("WT_A")
)

sample_label_WT_B <- resolve_sample_label(
  "WT_B", c("WT_B")
)

sample_label_ino80_A <- resolve_sample_label(
  "ino80_A", c("ino80_A")
)

sample_label_ino80_B <- resolve_sample_label(
  "ino80_B", c("ino80_B")
)

message("Using samples:")
print(data.frame(
  plot_label = c("WT_A", "WT_B", "ino80_A", "ino80_B"),
  header_label = c(
    sample_label_WT_A,
    sample_label_WT_B,
    sample_label_ino80_A,
    sample_label_ino80_B
  )
))
...
sample_mats <- list(
  "WT_A"    = getHeatSamp(sample_label_WT_A),
  "ino80_A" = getHeatSamp(sample_label_ino80_A)
)
...
ggsave(
  "combined_TES_ggheatmap_WT_A_ino80_A.png",
  plot = final_plot,
  width = 16,
  height = 9,
  dpi = 300
...
df_summary <- rbind(
  getAverageProfileSample(sample_label_WT_A,    "WT_A"),
  getAverageProfileSample(sample_label_WT_B,    "WT_B"),
  getAverageProfileSample(sample_label_ino80_A, "ino80_A"),
  getAverageProfileSample(sample_label_ino80_B, "ino80_B")
)
...
df_summary$sample <- factor(
  df_summary$sample,
  levels = c("WT_A", "WT_B", "ino80_A", "ino80_B")
)
...
ggProfile <- ggplot(
  ...
  scale_color_manual(values = c("#2166AC", "#67A9CF", "#B2182B", "#EF8A62")) +
...
pdf("reg_score_profile_compare_TES_WT_ino80.pdf", width = 20, height = 12)
print(ggProfile)
dev.off()

ggsave(
  "reg_score_profile_compare_TES_WT_ino80.png",
  plot   = ggProfile,
  width  = 20,
  height = 12,
  dpi    = 300
