...
pdf("TES_profile_lt1000bp.pdf", width=14, height=7)
...
cat("Saved: TES_profile_lt1000bp.pdf\n")
...
if (length(missing) > 0) {
  ...
  pdf("TES_profile_rapamycin_summary_lt1000bp.pdf", width = 12, height = 6)
  ...
  dev.off()
  cat("Saved: TES_profile_rapamycin_summary_lt1000bp.pdf\n")
}