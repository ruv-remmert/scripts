...
group_files <- c(
  ...
  TSS_divergent = "../../../plus1_nucleosome/divergent/TSS_regSorted_divergent.bed",
  TSS_lonely    = "../../../plus1_nucleosome/lonely/TSS_regSorted_lonely.bed",
  TSS_tandem    = "../../../plus1_nucleosome/tandem/TSS_regSorted_tandem.bed"
)
