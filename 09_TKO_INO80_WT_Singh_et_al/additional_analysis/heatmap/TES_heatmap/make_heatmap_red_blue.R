...
sample_label_TKO_Ino80_Rapamycin_90_min_Rep1 <- resolve_sample_label(
  ...
  c(
    "TKO_Ino80_Rapamycin_90_min_Rep_1"
  )
)
...
sample_label_WT_Ino80_Rapamycin_90_min_Rep1 <- resolve_sample_label(
  ...
  c(
    "WT_Ino80_Rapamycin_90_min_Rep_1"
  )
)
...
sample_mats <- list(
  ...
  "TKO_Ino80_Rapamycin_90_min_Rep1" = getHeatSamp(
    sample_label_TKO_Ino80_Rapamycin_90_min_Rep1
  ),

  "WT_Ino80_Rapamycin_90_min_Rep1" = getHeatSamp(
    sample_label_WT_Ino80_Rapamycin_90_min_Rep1
  )
)
...
pdf("reg_score_profile_compare_TES.pdf", width = 20, height = 12)
print(ggProfile)
dev.off()

ggsave(
  "reg_score_profile_compare_TES.png",
  plot   = ggProfile,
  width  = 20,
  height = 12,
  dpi    = 300
