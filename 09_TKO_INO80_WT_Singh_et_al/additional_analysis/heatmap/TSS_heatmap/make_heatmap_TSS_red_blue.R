...
sample_label_Wild_type_Rep2 <- resolve_sample_label(
  "Wild_type_Rep2", c("Wild_type_Rep_2")
)

sample_label_TKO_Rep1 <- resolve_sample_label(
  "TKO_Rep1", c("TKO_Rep_1")
)

sample_label_TKO_Ino80_Rapamycin_90_min_Rep1 <- resolve_sample_label(
  "TKO_Ino80_Rapamycin_90_min_Rep1", c("TKO_Ino80_Rapamycin_90_min_Rep_1")
)

sample_label_WT_Ino80_Rapamycin_90_min_Rep1 <- resolve_sample_label(
  "WT_Ino80_Rapamycin_90_min_Rep1", c("WT_Ino80_Rapamycin_90_min_Rep_1")
)
...
print(data.frame(
  plot_label = c(
    "Wild_type_Rep2",
    "TKO_Rep1",
    "TKO_Ino80_Rapamycin_90_min_Rep1",
    "WT_Ino80_Rapamycin_90_min_Rep1"
  ),
  header_label = c(
    sample_label_Wild_type_Rep2,
    sample_label_TKO_Rep1,
    sample_label_TKO_Ino80_Rapamycin_90_min_Rep1,
    sample_label_WT_Ino80_Rapamycin_90_min_Rep1
  )
))
...
sample_mats <- list(
  "Wild_type_Rep2"                        = getHeatSamp(sample_label_Wild_type_Rep2),
  "TKO_Rep1"                              = getHeatSamp(sample_label_TKO_Rep1),
  "TKO_Ino80_Rapamycin_90_min_Rep1"       = getHeatSamp(sample_label_TKO_Ino80_Rapamycin_90_min_Rep1),
  "WT_Ino80_Rapamycin_90_min_Rep1"        = getHeatSamp(sample_label_WT_Ino80_Rapamycin_90_min_Rep1)
)
...
df_summary <- rbind(
  getAverageProfileSample(sample_label_Wild_type_Rep2,                        "Wild_type_Rep2"),
  getAverageProfileSample(sample_label_TKO_Rep1,                              "TKO_Rep1"),
  getAverageProfileSample(sample_label_TKO_Ino80_Rapamycin_90_min_Rep1,       "TKO_Ino80_Rapamycin_90_min_Rep1"),
  getAverageProfileSample(sample_label_WT_Ino80_Rapamycin_90_min_Rep1,        "WT_Ino80_Rapamycin_90_min_Rep1")
)
