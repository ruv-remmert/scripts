...
group_files <- c(
  TES_convergent = "../../../TES/convergent/TES_regSorted_convergent.bed",
  TES_lonely    = "../../../TES/lonely/TES_regSorted_lonely.bed",
  TES_tandem    = "../../../TES/tandem/TES_regSorted_tandem.bed",
  TSS_divergent = "../../divergent/TSS_regSorted_divergent.bed",
  TSS_lonely    = "../../lonely/TSS_regSorted_lonely.bed",
  TSS_tandem    = "../../tandem/TSS_regSorted_tandem.bed"
)
