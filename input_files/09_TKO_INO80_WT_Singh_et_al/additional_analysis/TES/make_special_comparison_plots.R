...
############################################
# Plot 3: TKO (grey filled) vs TKO - INO80 (purple) vs TKO - Pol II - INO80 (yellow dashed)
############################################
...
if (has_polii_ino80) {
    ...
    draw_plot3 <- function() {
        ...
        plot(pos, tko_vals,
             ...
             xlab = NA,
             ylab = "Nucleosome Occupancy",
             main = "TES: TKO vs TKO - INO80 vs TKO - Pol II - INO80",
